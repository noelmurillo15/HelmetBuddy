...
//    Button settingsBtn;
    ...
    //  TODO : if I create helmet icon and turn off bt and gps and click helmet icon, helmet icon will disappear abd will not continue to scan for devices
